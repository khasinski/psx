...
Think of it as an executable spec for the PS1. 374/374 unit tests,
...
- SPU: register window read-back, RAM DMA/FIFO transfers, IRQ9 RAM checks,
  ...
  fixed/current volume registers, basic volume sweep, noise voices,
  CDDA/CD-XA queue mixing, and stereo PCM output. Reverb and full ADSR
